...
import com.zoatech.lostandfound.camera.CameraManager;
import com.zoatech.lostandfound.camera.IAutoFocusListener;
import com.zoatech.lostandfound.camera.ShutterButton;
import com.zoatech.lostandfound.ocr.OcrInitAsyncTask;
import com.zoatech.lostandfound.ocr.OcrResult;
import com.zoatech.lostandfound.ocr.OcrResultFailure;
import com.zoatech.lostandfound.ocr.OcrResultText;
import com.zoatech.lostandfound.ui.events.FinishListener;
import com.zoatech.lostandfound.ui.handlers.CaptureActivityHandler;
import com.zoatech.lostandfound.ui.handlers.DecodeHandler;
import com.zoatech.lostandfound.utils.BeepManager;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private IAutoFocusListener autoFocusLister = new IAutoFocusListener() {
        @Override
    ...
    public void onCreate(Bundle icicle) {
        ...
        findViewById(R.id.btn_details_captured).setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CaptureActivity.this, DetailsCapturedActivity.class);
    ...
    void onShutterButtonPressContinuous() {
        ...
        if (lastResult != null) {
            ...
            Toast toast = Toast.makeText(this, "Document capture failed. Please try again.", Toast.LENGTH_SHORT);
    ...
    private void initCamera(SurfaceHolder holder) {
        ...
        try {
            ...
            setupAutoFocusListener();

            // Creating the handler starts the preview, which can also throw a RuntimeException.
            handler = new CaptureActivityHandler(this, cameraManager, isContinuousModeActive);

        } catch (IOException ioe) {
            Log.e("Error", "Could not initialize camera. Please try restarting device.", ioe);
            showErrorMessage("Error", "Could not initialize camera. Please try restarting device.");
            ioe.printStackTrace();
        } catch (RuntimeException e) {
            Log.e("Error", "Could not initialize camera. Please try restarting device.", e);
    ...
    public void setupAutoFocusListener() {
        cameraManager.setAutofocusListener(autoFocusLister);
    }
    public void clearAutoFocusListener() {
        cameraManager.setAutofocusListener(null);
    }
    ...
    public boolean handleOcrDecode(OcrResult ocrResult) {
        ...
        lastBitmap = ocrResult.getOriginalBitmap();
        ...
        if (lastBitmap == null) {
            ...
            bitmap = getResizedBitmap(bitmap, (int)(bitmap.getWidth() * 1.5d), (int)(bitmap.getHeight() * 1.5d));
...
//        Toast toast = Toast.makeText(this, "OCR: eng", Toast.LENGTH_LONG);
//        toast.setGravity(Gravity.TOP, 0, 0);
//        toast.show();
    }
    ...
    public void displayProgressDialog() {
        ...
        if (ocrEngineModeName.equals("Both")) {
            indeterminateDialog.setMessage("Capturing document details...");
        } else {
            indeterminateDialog.setMessage("Capturing document details...");
        }
    ...
    public boolean isAutoFocusListenerSet() {
        return cameraManager.isAutoFocusListenerSet();
    }
}
