...
public final class ViewfinderView extends View {
     ...
     */
    public static final boolean DRAW_CHARACTER_BOXES = false;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultText != null) {
            ...
            if (bitmapSize.x == previewFrame.width() && bitmapSize.y == previewFrame.height()) {
                ...
                float scaleX = (frame.width() / (float) previewFrame.width()) * .95f;
                float scaleY = frame.height() / (float) previewFrame.height() * .95f;
