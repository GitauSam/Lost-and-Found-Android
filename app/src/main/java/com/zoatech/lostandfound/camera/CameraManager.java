...
import com.zoatech.lostandfound.bitmap.PlanarYUVLuminanceSource;
import com.zoatech.lostandfound.ui.PreferencesActivity;
...
public final class CameraManager {
    ...
    private static final int MIN_FRAME_WIDTH = 570; // originally 240
    private static final int MIN_FRAME_HEIGHT = 285; // originally 240
    private static final int MAX_FRAME_WIDTH = 720; // originally 480
    private static final int MAX_FRAME_HEIGHT = 440; // originally 360
    ...
    private IAutoFocusListener mAutofocusListener;
    ...
    public synchronized void startPreview() {
        ...
        if (theCamera != null && !previewing) {
            ...
            setAutofocusListener(this.mAutofocusListener);
        }
    }

    public void setAutofocusListener(IAutoFocusListener mAutofocusListener) {
        if (autoFocusManager != null) {
            if (this.mAutofocusListener != null)
                this.mAutofocusListener = mAutofocusListener;

            this.autoFocusManager.setAutoFocusListener(this.mAutofocusListener);
        } else {
            this.mAutofocusListener = mAutofocusListener;
        }
    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = (int)(screenResolution.x * 0.75);
            if (width < MIN_FRAME_WIDTH) {
                width = MIN_FRAME_WIDTH;
            } else if (width > MAX_FRAME_WIDTH) {
                width = MAX_FRAME_WIDTH;
            }
            int height = (int)(screenResolution.y * 0.75);
    ...
    public boolean isAutoFocusListenerSet() {
        return mAutofocusListener != null;
    }
}
